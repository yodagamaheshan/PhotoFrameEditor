...
open class WDColorPickerView: UIView, ColorPickerViewDelegate {
    ...
    class func showOverlay()
    {
        ...
        let horizontalConstraint = NSLayoutConstraint(item: overlay!, attribute: NSLayoutConstraint.Attribute.centerX, relatedBy: .equal, toItem: WDColorPickerView.topView, attribute: NSLayoutConstraint.Attribute.centerX, multiplier: 1, constant: 0)
        let verticalConstraint = NSLayoutConstraint(item: overlay!, attribute: NSLayoutConstraint.Attribute.centerY, relatedBy: NSLayoutConstraint.Relation.equal, toItem: WDColorPickerView.topView, attribute: NSLayoutConstraint.Attribute.centerY, multiplier: 1, constant: 0)
        let widthConstraint = NSLayoutConstraint(item: overlay!, attribute: NSLayoutConstraint.Attribute.width, relatedBy: NSLayoutConstraint.Relation.equal, toItem: WDColorPickerView.topView, attribute: NSLayoutConstraint.Attribute.width, multiplier: 1, constant: 0)
        let heightConstraint = NSLayoutConstraint(item: overlay!, attribute: NSLayoutConstraint.Attribute.height, relatedBy: NSLayoutConstraint.Relation.equal, toItem: WDColorPickerView.topView, attribute: NSLayoutConstraint.Attribute.height, multiplier: 1, constant: 0)
    ...
    public class func showPicker(delegate:Any? = nil, initialColor:UIColor? = nil)
    {
        ...
        let horizontalConstraint2 = NSLayoutConstraint(item: colorPicker, attribute: NSLayoutConstraint.Attribute.centerX, relatedBy: NSLayoutConstraint.Relation.equal, toItem: WDColorPickerView.topView, attribute: NSLayoutConstraint.Attribute.centerX, multiplier: 1, constant: 0)
        let verticalConstraint2 = NSLayoutConstraint(item: colorPicker, attribute: NSLayoutConstraint.Attribute.centerY, relatedBy: NSLayoutConstraint.Relation.equal, toItem: WDColorPickerView.topView, attribute: NSLayoutConstraint.Attribute.centerY, multiplier: 1, constant: 0)
        let widthConstraint2 = NSLayoutConstraint(item: colorPicker, attribute: NSLayoutConstraint.Attribute.width, relatedBy: NSLayoutConstraint.Relation.equal, toItem: nil, attribute: NSLayoutConstraint.Attribute.notAnAttribute, multiplier: 1, constant: minDim * 0.7)
        let heightConstraint2 = NSLayoutConstraint(item: colorPicker, attribute: NSLayoutConstraint.Attribute.height, relatedBy: NSLayoutConstraint.Relation.equal, toItem: nil, attribute: NSLayoutConstraint.Attribute.notAnAttribute, multiplier: 1, constant: minDim * 0.7)
